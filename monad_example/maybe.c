...
int Maybe_m_then(TCObject* self, TCObject* next) {return 0;}

int Maybe_f_fmap(TCObject* _self, TCObject* _next, f_fmap_callback cb)
{
  Maybe* self = (Maybe*) _self;
  Maybe* next = (Maybe*) _next;
  if (is_nothing(self) && self != next) {
...
int Maybe_a_pure(TCObject* _self, void* data)
{
  Maybe* self = (Maybe*) _self;
  just(self, data);
  return 0;
...
int Maybe_a_ap(TCObject* _self, TCObject* _a, TCObject* _b)
{
  Maybe* self = (Maybe*) _self;
